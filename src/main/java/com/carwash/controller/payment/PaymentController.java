...
public class PaymentController {
    ...
    public ResponseEntity<PaymentPreviewResponse> preview(Authentication auth,
    ...
    public ResponseEntity<PaymentResponse> pay(Authentication auth,
                                               @RequestParam Long appointmentId,
...
//    @GetMapping("/payments/by-appointment")
//      public ResponseEntity<PaymentResponse> getByAppointment(Authentication authentication,
//                                                              @RequestParam Long appointmentId) {
// 
//          return ResponseEntity.ok(paymentService.getByAppointment(authentication.getName(), appointmentId));
//      }
